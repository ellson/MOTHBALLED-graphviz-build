...
foreach {a1 a2 a3 a4 a5 a6} $argv {break}
...
switch $argc {
	...
	5 { spawn cvs -d :pserver:anoncvs@cvs-graphviz.research.att.com:/home/cvsroot $a1 $a2 $a3 $a4 $a5 }
	6 { spawn cvs -d :pserver:anoncvs@cvs-graphviz.research.att.com:/home/cvsroot $a1 $a2 $a3 $a4 $a5 $a6 }
}
while {1} {
        expect timeout {
