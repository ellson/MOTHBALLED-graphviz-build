...
work=$HOME/tmp/gviz
PREFIX=$HOME/FIX/MountainLion.x86_64
export PREFIX
PATH=$PREFIX/bin:$PATH
export PATH

SOURCES=$GRAPHVIZ_PUB_PATH/SOURCES
PKGS=$GRAPHVIZ_PUB_PATH/macos/mountainlion
...
then
	...
	(cd $source/macosx/graphviz.xcodeproj; cp mountainlion.project.pbxproj project.pbxproj)
	(cd $source/macosx/build; cp Makefile.mountainlion Makefile)
