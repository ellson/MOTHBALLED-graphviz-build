...
BUILD_HOSTS="bld-centos7 bld-centos7-32 bld-centos6 bld-centos6-32 bld-centos5 bld-centos5-32"
parallel -j 2 --arg-sep ::: ssh -x gviz@{} PATH=/usr/bin:/bin:$PATH graphviz-build/redhat/graphviz-bin-rpm.tcl $DIR ::: $BUILD_HOSTS
